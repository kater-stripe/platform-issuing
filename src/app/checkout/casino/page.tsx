...
export default function CasinoCheckoutPage() {
  ...
  const merchant = DEMO_CONFIG.merchants.blocked.find(m => m.name === 'Casino')!;
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-red-50 border border-red-200 rounded-xl p-6 mb-6">
          <div className="flex items-start space-x-3">
            ...
            <div>
              <h3 className="text-lg font-semibold text-red-900 mb-2">Spending Policy Violation</h3>
              <p className="text-red-800">
                Gambling transactions are blocked by your company's spending policy. 
                This transaction will be automatically declined during authorization.
              </p>
              <p className="text-red-700 text-sm mt-2">
                This page demonstrates how blocked merchant categories are handled in real-time.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-xl shadow-sm p-6">
              <h2 className="text-xl font-semibold text-gray-900 mb-4">Casino Products</h2>
              
              <div className="grid grid-cols-1 gap-4">
                {merchant.products.map((product) => (
                  <div key={product.id} className="border border-gray-200 rounded-lg p-4 bg-red-50">
                    <div className="flex justify-between items-start mb-2">
                      <div>
                        ...
                        <p className="text-xs text-red-600 mt-1">
                          ⚠️ This purchase will be declined due to spending policy
                        </p>
                      </div>
              ...
              {Object.keys(selectedProducts).length === 0 ? (
                ...
                <>
                  ...
                  <p className="text-xs text-red-600 text-center mt-2">
                    ⚠️ This transaction will be automatically declined
                  </p>
                </>
              )}
            </div>
              ...
              {authResult.reason && (
                <div className="mt-3 p-3 bg-yellow-50 border border-yellow-200 rounded">
                  <p className="text-sm text-yellow-800">
                    <strong>Reason:</strong> {authResult.reason}
                  </p>
                </div>
              )}
              ...
              {!authResult.authorized && (
                <div className="mt-3 p-3 bg-blue-50 border border-blue-200 rounded">
                  <p className="text-sm text-blue-800">
                    <strong>Demo Note:</strong> This demonstrates real-time spending controls blocking gambling transactions as per company policy.
                  </p>
                </div>
              )}
            </div>
